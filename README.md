<div align="center">
  ...
  # DEMOCRATIC ROACH FRONT (DRF)
  
  <p><strong>A Premium Cyber-Political Activism Portal and National Reform Platform for the Indian Youth.</strong></p>
  ...
  <p>
    ...
    <a href="#-local-setup"><b>Setup & Dev</b></a>
  </p>

  <img src="https://img.shields.io/badge/Next.js-15.5_App_Router-000000?style=flat-square&logo=next.js" alt="Next.js" />
  <img src="https://img.shields.io/badge/TailwindCSS-v4-38BDF8?style=flat-square&logo=tailwind-css" alt="TailwindCSS" />
  <img src="https://img.shields.io/badge/MongoDB-Atlas_Mongoose-47A248?style=flat-square&logo=mongodb" alt="MongoDB" />
  <img src="https://img.shields.io/badge/Framer_Motion-Smooth_Kinetic-F107A3?style=flat-square&logo=framer" alt="Framer Motion" />
  <img src="https://img.shields.io/badge/Node_Registration-LIVE-8B0000?style=flat-square" alt="DRF Active" />
...
- **Background Palette**: Primary Light `#F8F8F6` and Secondary Card White `#FFFFFF` for high-contrast reading.
- **Accent Palette**: Solid Crimson Red `#8B0000` paired with Deep Crimson Shadows `#5E0B15` to represent systemic resilience.
...
- **Typography**: Paired modern neo-grotesque sans-serif headers with monospace tracking codes (`Geist` and `Geist Mono`).

---

## ⚡ Core Features

* **Official Member Enlistment**: A clean, official 2x2 grid form registering name, secure email, home state, and age group.
* **Auto-Generated Roach IDs**: Dynamically generates unique sequential member IDs (e.g. `DRF-001001`, `DRF-001002`) based on database registration sequence.
* **Automated Geolocation Tracking**: Silently logs incoming members' public IP address, resolved city, state/region, country name, and exact latitude/longitude coordinates to the database.
...
* **Official National Manifesto Page (`/manifesto`)**:
  - Implements the complete **National Manifesto** text.
  - Desktop: Sidebar table of contents with scroll position tracking and smooth-scrolling links.
  - Mobile: Transitions into a clean, single-column reading mode.
* **Global Custom Cursor**: A custom red glow magnetic dot cursor tracing interactive elements on the screen. Disables itself automatically on touch/mobile devices to prevent touch conflicts.
...
│   │   ├── api/
│   │   │   └── enlist/
│   │   │       └── route.ts       # Database transactional handler & IP/Geo logger
│   │   ├── manifesto/
│   │   │   └── page.tsx           # Full manifesto document subpage
...
│   │   └── page.tsx               # Main assembly landing page
│   │
│   ├── components/
...
│   │   ├── Agenda.tsx             # Six policies grid framework
│   │   ├── YouthVoices.tsx        # Anonymous submissions marquee wall
│   │   ├── RoachersCounter.tsx    # Live statistics section
│   │   ├── Manifesto.tsx          # Manifesto summary & navigation sub-link
│   │   ├── JoinForm.tsx           # Geolocation-enriched secure registration form
│   │   ├── Footer.tsx             # Swiss minimalist bottom layout
│   │   ├── Loader.tsx             # Loading sequence flashing fix
│   │   ├── NoiseOverlay.tsx       # Film grain overlay
│   │   └── CustomCursor.tsx       # Touch-safe custom cursor
│   │
│   ├── lib/
